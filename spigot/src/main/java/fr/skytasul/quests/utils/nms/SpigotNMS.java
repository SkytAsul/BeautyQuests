...
public class SpigotNMS extends NMS{

	private Field customTagField;

	public SpigotNMS() throws NoSuchFieldException, SecurityException {
	...
	public List<String> getAvailableBlockProperties(Material material) {
		...
		Reference<Block> block = blockRegistry
				.getOrThrow(ResourceKey.create(Registries.BLOCK, Identifier.parse(material.getKey().toString())));
