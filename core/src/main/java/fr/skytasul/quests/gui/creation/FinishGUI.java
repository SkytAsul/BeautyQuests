...
public class FinishGUI extends UpdatableOptionSet<Updatable> implements CustomInventory {
	...
	public static void initialize(){
		...
		QuestsAPI.registerQuestOption(new QuestOptionCreator<>("scoreboard", 20, OptionScoreboardEnabled.class, OptionScoreboardEnabled::new, true));
		QuestsAPI.registerQuestOption(new QuestOptionCreator<>("hide", 21, OptionHide.class, OptionHide::new, false, "hid"));
		QuestsAPI.registerQuestOption(new QuestOptionCreator<>("repeatable", 22, OptionRepeatable.class, OptionRepeatable::new, false, "multiple"));
		QuestsAPI.registerQuestOption(new QuestOptionCreator<>("timer", 23, OptionTimer.class, OptionTimer::new, QuestsConfiguration.getTimeBetween()));
