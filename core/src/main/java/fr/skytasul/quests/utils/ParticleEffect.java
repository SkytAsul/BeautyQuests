...
public enum ParticleEffect {
	...
	private ParticleEffect(ParticleProperty... properties) {
		this(0, 0, properties);
	}

	private ParticleEffect(int min, ParticleProperty... properties) {
		this(min, 0, properties);
	}
	
	private ParticleEffect(int min, int max, ParticleProperty... properties) {
	...
	public static ParticleEffect fromName(String name) {
		for (ParticleEffect effect : values()){
			if (effect.name().equalsIgnoreCase(name)) {
				if (!effect.isSupported()) throw new ParticleVersionException();
				return effect;
			}
		}
	...
	public static final class ParticlePacket {
		 ...
		 */
		public ParticlePacket(ParticleEffect effect, double offsetX, double offsetY, double offsetZ, double speed, int amount, boolean longDistance, Object data) throws IllegalArgumentException {
			initialize();
			if (speed < 0) {
